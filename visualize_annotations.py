...
# for visualizing the predicted bounding box on each frame
# Note that you should replace <annot-path>, <clips-root>, and <vis-save-root> with your annotation file (e.g. vq_val.json), 
# the folder contains all clips, and the output folder of the visualization results, respectively.
# e.g.: python3 visualize_annotations.py --annot-path DLCV_vq2d_data/vq_val.json --clips-root DLCV_vq2d_data/clips --vis-save-root DLCV_vq2d_data/saveval
